        ...
        <div class="px-6 pb-4">
            <div class="flex items-center justify-between mb-3">
                ...
                <button onclick="copyToClipboard('{{ addslashes($prompt->prompt_text) }}')"
                    class="copy-btn inline-flex items-center px-3 py-1 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 hover:border-blue-400 hover:text-blue-700 transition-all duration-300">
...
@empty
    <div class="col-span-full text-center py-12">
        ...
        <h3 class="text-lg font-medium text-gray-900 mb-2">{{ __('messages.prompts.no_prompts') ?? 'No prompts found' }}</h3>
        <p class="text-gray-600">{{ __('messages.prompts.no_prompts_desc') ?? 'No prompts match your current filters.' }}</p>
    </div>
@endforelse
